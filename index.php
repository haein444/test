            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=therapists"></span>Therapists</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=feedback"></span>Feed Back</a></li>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=status"></span>Application Status</a></li>
