<?php include 'admin/db_connect.php'; 
	...
	$special = $conn->query("SELECT * FROM specialty");
	$ms_arr = array();
...
?>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Therapists</h3>
	...
	<section class="page-section" id="therapists" >
        <div class="container">
        	<div class="card">
        		<div class="card-body">
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								<?php
								$s = $conn->query("SELECT * from specialty where id = ".$_GET['sid'])->fetch_array()['name'];
								?>
								<h2><b>Therapists who are in titled as <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				$cats = $conn->query("SELECT * FROM therapists_list ".$where." order by id asc");
